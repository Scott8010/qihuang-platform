...
def test_new_sources_registered_offline():
    ...
    for key in ("baike-tcm", "baike-360", "baike-com", "tcm-dayi", "ctext", "jicheng", "tcm-encyclopedia", "static-demo"):
    ...
    assert rep.total == 0, rep.to_dict()
    assert rep.ingested == 0, rep.to_dict()
